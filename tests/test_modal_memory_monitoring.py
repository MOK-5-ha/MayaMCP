...
class TestMemoryMonitor:
    ...
    def test_get_memory_usage_mb(self, mock_read):
        ...
        mock_read.return_value = (100000000, None)  # 100MB
        monitor = MemoryMonitor()
...
class TestMayaSessionManager:
    ...
    def test_access_existing_session(self):
        ...
        accessed = manager.access_session("test123")
    ...
    def test_access_nonexistent_session(self):
        ...
        accessed = manager.access_session("nonexistent")
    ...
    def test_get_statistics(self):
        ...
        # Create and reject sessions
        manager.create_session("test1", "keyhash")
        manager.create_session("test2", "keyhash")
        manager.create_session("test3", "keyhash")  # This might succeed or fail depending on limits
        
        stats = manager.get_statistics()
        
        assert stats["current_sessions"] >= 2
        assert stats["max_sessions"] == manager.max_sessions_per_container
