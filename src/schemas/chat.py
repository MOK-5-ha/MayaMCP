...
class ChatResponse(BaseModel):
    ...
    audio_base64: str | None = Field(None, description="Optional base64 encoded audio string from TTS")
    payment_summary: dict[str, Any] = Field(default_factory=dict, description="Current tab, balance, tip info")
    quota_error_html: str | None = Field(None, description="HTML error message if quota exceeded")
