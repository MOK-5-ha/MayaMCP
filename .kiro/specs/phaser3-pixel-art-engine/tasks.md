...
### Track 1: Backend SSE Adapter & Static Server

#### Task 1.1: Implement FastAPI SSE Endpoint for Streamed Chat & Visemes
...
#### Task 1.2: Update Modal Labs Deployment for Static Vite Bundle Mount
* **Traceability:** `NFR-3`
...
### Track 2: Phaser 3 Core Engine Setup

> [!TIP] PARALLEL EXECUTION
> Track 2 can be developed alongside Track 1 using mocked backend SSE data.

#### Task 2.1: Initialize Phaser 3 Canvas with Nearest-Neighbor Pixel Art Engine
...
#### Task 2.2: Implement Declarative Asset Loader (`assets_manifest.json`)
...
### Track 3: Character Sprite Layer & Viseme Mouth-Flap Controller

#### Task 3.1: Create Multi-Layer Character Sprite Component (`MayaCharacter.ts`)
...
#### Task 3.2: Implement Audio & Text-Synced Mouth-Flap Animator
...
### Track 5: Cyberpunk Bartending HUD & Payment UI

#### Task 5.1: Build Interactive Pixel-Art Drink Mixer HUD
...
#### Task 5.2: Build Coinbase CDP AgentKit Crypto Payment Overlay
* **Traceability:** `FR-5.2`
...
#### Task 6.1: Run Full Cyberpunk Bartending Session E2E Test
