...
- [x] 12. Add payment tools to LLM tool list
  - [x] 12.1 Register new payment tools in get_all_tools
    - Add add_to_order_with_balance, get_balance, create_stripe_payment, check_payment_status
    - _Requirements: 1.2, 1.4, 3.1, 3.3_

- [x] 13. Extend payment state with tipping fields
  - [x] 13.1 Add tip fields to PaymentState schema
  ...
  - [x] 13.7 Write property test for tip toggle behavior
  ...
  - [x] 13.8 Write property test for total calculation with tip
  ...
  - [x] 13.9 Write property test for tip replacement
  ...
  - [x] 13.10 Write property test for tip reset on payment
...
- [x] 14. Implement tipping tools
  - [x] 14.1 Implement set_tip LLM tool
    ...
    - _Requirements: 7.2, 7.5, 7.6_
  - [x] 14.2 Implement get_tip LLM tool
    - Return current tip_percentage, tip_amount, tab, total
    - _Requirements: 7.3, 7.4_
  - [x] 14.3 Add INVALID_TIP_PERCENTAGE to PaymentError enum
    - Error for percentages not in {10, 15, 20}
    - _Requirements: 7.2_
  - [x] 14.4 Register tip tools in get_all_tools
